...
const situations = [
  {
    ...
    description: "Practice starting a conversation with someone you don't know.",
  },
  {
    id: "crush",
    title: "Talk to a crush",
    description: "Practice keeping a conversation natural and interesting.",
  },
  {
    id: "college",
    title: "College conversation",
    description: "Practice talking to classmates or people around campus.",
  },
  {
    id: "interview",
    title: "Job interview",
    description: "Practice answering questions without freezing up.",
  },
  {
    id: "professor",
    title: "Talk to a professor",
    description: "Practice asking questions or starting a conversation.",
  },
  {
    id: "group",
    title: "Join a group",
    description: "Practice entering an ongoing group conversation.",
  },
]
        ...
        <section className="mt-16">
          ...
          <div className="mb-6 flex items-center justify-between">
            ...
            <span className="text-xs text-white/20">
              {selectedSituation ? "1 selected" : "Choose one"}
            </span>
          </div>
              ...
              return (
                ...
                >
                  <div className="flex items-start justify-between">
                    ...
                    >
                      0{situations.indexOf(situation) + 1}
                    </span>
